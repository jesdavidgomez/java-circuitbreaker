package com.circuitbraker.config;
...
public class CircuitBreakerConfiguration {
    ...
    public CircuitBreaker circuitBreaker() {
        return CircuitBreaker.of("mi-primer-cb", this.buildConfig1());

    }

    CircuitBreakerConfig buildConfig1() {
        return CircuitBreakerConfig.custom().slidingWindowType(CircuitBreakerConfig.SlidingWindowType.COUNT_BASED).slidingWindowSize(4) // default
                // 100
    ...
    CircuitBreakerConfig buildConfig4() {
        ...
        return CircuitBreakerConfig.custom().slidingWindowType(CircuitBreakerConfig.SlidingWindowType.TIME_BASED).slidingWindowSize(4) // default
                // 100
                .failureRateThreshold(50f) // default 100%
                .permittedNumberOfCallsInHalfOpenState(2) // default 10
